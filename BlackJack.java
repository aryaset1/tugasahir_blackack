...
public class BlackJack {
        ...
        public void paintComponent(Graphics g) {
            ...
            try {
                ...
                if (!stayButton.isEnabled()) {
                    ...
                    // Update the Wins label
                    scoreLabel.setText("Wins: " + threeInARow.getKemenangan());
                }
    ...
    JButton hitButton = new JButton("take");
    JButton stayButton = new JButton("Start");
    JLabel scoreLabel; // Declare scoreLabel
        ...
        hitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (playerSum > dealerSum) {
                    threeInARow.tambahKemenangan();
                    highScore.addScore(frame.getTitle(), playerSum);
                }
